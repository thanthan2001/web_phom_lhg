...
if (!defined("API_BASE_URL")) {
    define("API_BASE_URL", "http://192.168.30.19:8181/api");
}

return [
    "auth_login" => API_BASE_URL . "/auth/login",
    // "get_user_info" => API_BASE_URL . "/auth/getUserById",
    "get_officer_info" => API_BASE_URL . "/auth/get_officer_info",
    ...
    "controlPhom" => API_BASE_URL . '/phom/controlPhom',
    "getAllLastNo" => API_BASE_URL . '/phom/getAllLastNo',
    "thongkephom" => API_BASE_URL . '/phom/statisticalParameters',
];